...
const Trailer = (props) => {
  ...
  useEffect(() => {
    // This effect runs every time the selectedMovie state changes.
    // Here, we update the document title with the selected movie's title.
    document.title = selectedMovie ? `${selectedMovie.title} - My App` : 'My App';
  }, [selectedMovie]);
  ...
  return (
    <div>
      <ul>
      <li key={2}>{selectedMovie.title}</li>
      </ul>
